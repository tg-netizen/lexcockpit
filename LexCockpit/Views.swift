...
// MARK: - Projects (your own work)

struct ProjectsView: View {
    @EnvironmentObject var store: CockpitStore
    var body: some View {
        Page(title: "Projects", subtitle: "Your editorial pipeline — draft, scheduled, published") {
            HStack {
                Button {
                ...
                Spacer()
                Text("\(store.projects.count) projects").foregroundColor(.secondary).font(.callout)
            }
            ...
            if store.projects.isEmpty {
                Card {
                    VStack(alignment: .leading, spacing: 6) {
                        ...
                        Text("Run `node scripts/build-projects.js` in your website repo to generate projects.json from content/articles, then open it above.")
